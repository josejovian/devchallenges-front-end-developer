...
const Stay: React.FC<StayInterface> = ({
	superHost,
	title,
	rating,
	type,
	...
	return (
		<article className={clsx("flex flex-col gap-4")}>
			<section className={clsx("overflow-hidden h-min aspect-video rounded-lg")}>
				<img src={photo} alt={title} />
			</section>
			<section className={clsx("flex justify-between text-sm")}>
				...
				<section className="flex items-center gap-2">
					<MdStar className="text-red-600" /> {rating}
				</section>
			</section>
...
export const stays: StayInterface[] = [
	{
		city: "Helsinki",
		country: "Finland",
		superHost: false,
